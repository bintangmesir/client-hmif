...
import useCreateDataBuku from "../_hooks/useCreateDataBuku";
import useCsrfToken from "@/hooks/useCsrfToken";
import FormTextarea from "@/components/costum/FormTextarea";
import FormFile from "@/components/costum/FormFile";

const CardCreateDataBuku = () => {
  useCsrfToken();
  const { form, isLoading, onSubmit } = useCreateDataBuku();
    ...
    <Form {...form}>
      ...
      >
        <Card className="border-2 border-primary">
          <CardHeader>
            <CardTitle>Create Data Buku</CardTitle>
            <CardDescription>Form for create data buku</CardDescription>
          </CardHeader>
          <CardContent>
            <FormInput
              form={form.control}
            ...
            />
            <FormFile form={form.control} name={"cover"} />
          </CardContent>
...
export default CardCreateDataBuku;
